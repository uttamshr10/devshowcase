"""
Django settings for devshowcase project.
...
SECRET_KEY = 'DKFJASDKLFJAKLDSJFKLJADSLFJLASJDLF'
...
STATIC_URL = 'static/'
MEDIA_URL = '/images/'  # deals with the URL of user generated content

STATICFILES_DIRS = [    # where to look for static files (css, js and images)
...
# For sending email to new registered user
